...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center h-screen bg-black">
      <h1 className="text-[54px] leading-[40px] md:text-[156px] md:leading-[115px] tracking-[-0.06em] text-white">STAY TUNED</h1>
      <p className="text-[12px]md:text-[16px] leading-[12px]  pt-10 text-white">
        WE'LL BE BACK SOON WITH A BANG.
      </p>

      <Link
        href="mailto:admin@fortaxe.com"
        className="absolute bottom-4 md:bottom-[50px] left-4 md:left-[50px] text-white hover:opacity-80 transition-opacity text-[12px] md:text-[16px] leading-[12px]"
      >
        admin@fortaxe.com
      </Link>
      ...
      <Link
        ...
        className="absolute bottom-4 md:bottom-[50px] right-4 md:right-[50px] text-white hover:opacity-80 transition-opacity text-[12px] md:text-[16px] leading-[12px]"
      >
        +91 9676675576
      </Link>
    </main>
